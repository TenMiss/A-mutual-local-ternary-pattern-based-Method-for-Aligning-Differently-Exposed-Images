function [rotation, translation,sigbeta,Rshift,Cshift] = TH_imfLTPCoarseTune(T,Unregistered,ANG2,rmaxshift,cmaxshift,THbeta,DH,dbeta,TH1,TH2)
...
nAngs = length(angs);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[FT, FU] = TH_imfLTPFeature(T1,U1,TH1,TH2);
FTHC0 = histc(FT,0:80,1);
FTHR0 = histc(FT,0:80,2);
FTHC = FTHC0;
FTHR = FTHR0;
for WH =1:DH
...
for i = 1:nAngs
    ...
    FUHC0 = histc(FU1,0:80,1);
    FUHR0 = histc(FU1,0:80,2);
    FUHC = FUHC0;
    FUHR = FUHR0;
    for WH =1:DH
